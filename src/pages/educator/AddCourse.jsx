...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-betweens md:p-8 md:pb-0 p-4 pt-8 pb-0">
          ...
          {chapters.map((chapter, chapterIndex) => (
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 border-b">
                ...
                <span className=" text-gray-500">{chapter.chapterContent.legth} Lectures</span>
                <img
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div className="flex justify-between items-center mb-2" key={lectureIndex}>
                      <span>
                        ...
                        - {lecture.isPreviewFree ? "Free Preview" : "Paod"}
                      </span>
                      <img
                        src={assets.cross_icon}
                        alt=""
